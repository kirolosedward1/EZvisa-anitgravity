...
export function CookieConsent() {
  ...
  return (
    <>
      {/* Cookie Banner */}
      <div className="fixed bottom-4 right-4 z-50 p-5 bg-background/95 md:backdrop-blur-md border border-border shadow-2xl rounded-2xl max-w-md w-[calc(100vw-32px)] sm:w-[420px] max-h-[90vh] overflow-y-auto">
