          ...
          <div className="relative grid lg:grid-cols-[1.25fr_1fr] gap-12 lg:gap-16 p-8 md:p-14 lg:p-16 z-10">
            ...
            <div className="flex flex-col justify-center text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="https://wa.me/971585864446?text=Hi%20EZvisa!%20I%20have%20a%20question%20about%20my%20visa%20application." target="_blank" rel="noopener noreferrer" className="flex items-center">
                    Chat on WhatsApp
