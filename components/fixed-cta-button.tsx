  ...
  return (
    ...
    >
      <Link
        ...
        className="block w-full bg-gradient-to-r from-primary to-primary/90 text-primary-foreground rounded-xl shadow-2xl hover:shadow-xl transition-all duration-300 md:backdrop-blur-md border border-primary/20"
      >
