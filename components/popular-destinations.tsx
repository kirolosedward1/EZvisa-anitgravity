            ...
            >
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-20">
                  <div className="h-10 w-10 border border-white/30 rounded-full bg-black/20 md:backdrop-blur-md text-white group-hover:bg-white group-hover:text-black flex items-center justify-center transition-all duration-300 group-hover:scale-110 shadow-sm">
