  ...
  return (
    <section id="hero" className="relative overflow-hidden border-b border-border bg-background pt-12">
      ...
      <div className="relative container mx-auto px-4 pt-6 md:pt-10 lg:pt-12 pb-10 md:pb-12 max-w-6xl">
        ...
        <div className="absolute top-16 -left-16 w-[400px] h-[300px] pointer-events-none hidden lg:block select-none rotate-12 opacity-[0.22] dark:opacity-[0.15] dark:brightness-0 dark:invert z-10">
          <Image
