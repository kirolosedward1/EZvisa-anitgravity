                ...
                >
                  ...
                  <div className="relative aspect-[9/16] bg-gradient-to-br from-primary/10 to-primary/5 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-16 h-16 rounded-full bg-primary/90 md:backdrop-blur-md flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    ...
                    {/* Duration badge */}
                    <div className="absolute top-3 right-3 px-2 py-1 bg-black/75 md:backdrop-blur-md rounded-md flex items-center gap-1">
                      <Clock className="h-3 w-3 text-white" />
                      <span className="text-xs font-medium text-white">{video.duration}</span>
                    </div>

                    {/* View count */}
                    <div className="absolute bottom-3 left-3 px-2 py-1 bg-black/75 md:backdrop-blur-md rounded-md flex items-center gap-1">
